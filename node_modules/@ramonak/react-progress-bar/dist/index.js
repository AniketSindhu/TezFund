...
var ProgressBar = function (_a) {
    ...
    return (React.createElement("div", { style: outsideStyles, className: className, dir: dir, role: "progressbar", "aria-valuenow": parseFloat(labelStr), "aria-valuemin": ariaValuemin, "aria-valuemax": ariaValuemax, "aria-valuetext": "" + (ariaValuetext === null ? labelStr : ariaValuetext) },
        React.createElement("div", { style: containerStyles },
            React.createElement("div", { style: fillerStyles }, labelAlignment !== "outside" && (React.createElement("span", { style: labelStyles }, labelStr)))),
        labelAlignment === "outside" && (React.createElement("span", { style: labelStyles }, labelStr))));
};
